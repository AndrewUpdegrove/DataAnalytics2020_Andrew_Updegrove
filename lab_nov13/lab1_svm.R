...
m1 <- matrix( c( 
  0,0,0,1,1,2,1,2,3,2,3,3,0,1,2,3,0, 1, 2, 3, 
  1,2,3,2,3,3,0, 0, 0,1, 1, 2, 4, 4,4,4,0,1, 2, 3, 
...
# Create a svm for 7 varying costs.
# Green + are points with positive y values
# Blue x are points with negative y values
# Red circles are where which points were used for the support vector
# The support vectors were right at the boundary of the positive and negative y values
...
# test data
xtest <- rbind(matrix(rnorm(20),ncol=2),matrix(rnorm(20,mean=3),ncol=2))
